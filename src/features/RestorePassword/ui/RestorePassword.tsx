...
export const RestorePassword = () => {
	...
	return (
		<div className={style.restorePassword}>
			{
				isSuccess ? <p className={style.messageText}>На указанный Вами email отправлено сообщение для подтверждения</p> :
					<>
						<Title as='h2' className={style.title}>Восстановление пароля</Title>
						<p className={style.text}>Укажите ваш E-mail с которым вы проходили регистрацию и мы отправим код восстановления</p>
						<form
